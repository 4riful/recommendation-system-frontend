...
export default function CreateAddressPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a1a2e] to-[#283046] text-[#f8f8f2] p-6">
      <h1 className="text-2xl font-semibold text-center mb-6 text-[#f1fa8c]">Add Your Address</h1>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <label className="block text-sm font-medium flex-grow" htmlFor="city">
            City
          </label>
          <input
            type="text"
            ...
            required
            className="w-full px-4 py-2 rounded-md bg-[#6272a4] text-[#f8f8f2] focus:outline-none focus:ring-2 focus:ring-[#50fa7b] transition-all duration-200"
          />
        </div>

        <div className="flex items-center gap-2">
          <FaMapMarkerAlt className="text-[#50fa7b] text-lg" />
          <label className="block text-sm font-medium flex-grow" htmlFor="state">
            State / Division
          </label>
          <input
            type="text"
        ...
        <div className="flex items-center gap-2">
          <FaMapMarkerAlt className="text-[#50fa7b] text-lg" />
          <label className="block text-sm font-medium flex-grow" htmlFor="country">
            Country
          </label>
          <input
            type="text"
        ...
        >
          {loading ? "Saving..." : <><FaSave className="text-lg" /> Save Address</>}
        </button>
      </form>
    </div>
  );
